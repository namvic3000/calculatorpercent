...
class ButtonAfterAddedPercent extends React.Component {
    ...
    render() {
        ...
        return(
            <TouchableOpacity style={styles.percentButtonContainer} onPress={()=> {this.handleCalcButtonClicked("after added %")}}>
                <View>
                    <Text style={styles.afterPercentAddedButtonText}>after %</Text>
                    <Text style={styles.afterPercentAddedButtonText}>added</Text>
                </View>
            </TouchableOpacity>
        )
    }
...
export default connect(mapStateToProps)(ButtonAfterAddedPercent)